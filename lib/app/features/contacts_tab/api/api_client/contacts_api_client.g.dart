...
class _ContactsApiClient implements ContactsApiClient {
  ...
  @override
  Future<DeleteContactResponse> deleteContact(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'contactId': id};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DeleteContactResponse>(
  ...
  Future<UpdateContactResponse> updateContact(
    ...
    _data.addAll(body);
    final _options = _setStreamType<UpdateContactResponse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UpdateContactResponse _value;
    try {
      _value = UpdateContactResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<CreateContactResponse> createContact(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<CreateContactResponse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CreateContactResponse _value;
    try {
      _value = CreateContactResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
